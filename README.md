...
+ *"Cpp-Taskflow is the cleanest Task API I've ever seen." [Damien Hocking][damienhocking]*
...
+ *"Cpp-Taskflow helps improve the throughput of our graph processing engine in just a few hours of coding." [OSSIA project](https://ossia.io/)*
