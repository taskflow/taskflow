...
void traverse_regular_graph_omp(LevelGraph& graph, unsigned num_threads, int repeat){
...
std::chrono::microseconds measure_time_omp(LevelGraph& graph, unsigned num_threads, int repeat){
  auto beg = std::chrono::high_resolution_clock::now();
  traverse_regular_graph_omp(graph, num_threads, repeat);
