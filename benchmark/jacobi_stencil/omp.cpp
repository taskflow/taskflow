...
void wavefront_omp(unsigned num_threads, unsigned num_runs) {
...
std::chrono::microseconds measure_time_omp(unsigned num_threads, unsigned num_runs) {
  auto beg = std::chrono::high_resolution_clock::now();
  wavefront_omp(num_threads, num_runs);
