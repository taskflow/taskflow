...
TEST_CASE("CTZ") {
  ...
  REQUIRE(tf::portable_ctz<uint32_t>(0) == 32); // Undefined behavior, but testing edge case
  ...
  REQUIRE(tf::portable_ctz<uint64_t>(0) == 64); // Undefined behavior, but testing edge case
